              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=userlist/list" class="nav-link nav-enrollees">
                     ...
                     <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=message/list" class="nav-link nav-system_info">
                     ...
                     <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>statistique/list.php" class="nav-link nav-system_info">
                        <i class="nav-icon fas fa-users-cog"></i>
                        <p>
                        Statistics
                        </p>
                     ...
                     <li class="nav-item dropdown">
                      <a href="<?php echo base_url.'/classes/Login.php?f=logout' ?>" class="nav-link nav-system_info">
                        <i class="nav-icon fas fa-users-cog"></i>
                        <p>
                       Logout
                        </p>
